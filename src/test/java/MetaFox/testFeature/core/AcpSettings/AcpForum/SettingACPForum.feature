...
Feature: Config Settings On ACP Forums
  ...
  Scenario: Admin Config Forums OnACP
    ...
    And the user action on input field "inputForumMinimumNameLength" with value "5"
    And the user action on input field "inputForumMaximumNameLength" with value "255"
