...
public class Components {
    ...
    public List<WebElement> componentListTextLink(String linkText) {
        return Index.getDriver().findElements(By.xpath("//a[text()='" + linkText +"']"));
    }
    ...
    public List<WebElement> componentInputContainsID(String id) {
        return Index.getDriver().findElements(By.xpath("//input[(contains(@id,'" + id + "'))]"));
    }
    ...
    public List<WebElement> componentListSearchAttributes(String attributesName) {
        return Index.getDriver().findElements(By.xpath("//svg[@=data-testid'" + attributesName + "']"));
    }
    ...
    public WebElement componentInputName(String typename) {
        return Index.getDriver().findElement(By.xpath("//input[@name='" + typename + "']"));
    }
    ...
    public List<WebElement> componentsListTagButton(String labelValue) {
        return Index.getDriver().findElements(By.xpath("//button[contains(@aria-label,'"+labelValue+"')]"));
    }
    ...
    public WebElement componentH4Text(String textValue){
        return Index.getDriver().findElement(By.xpath("//h4[text()='"+textValue+"']"));
    }
    /**-----------------------------------------------------------------------------------------------------------------------------------------
     *
     * @param dataTestID is datatestID of element
    ...
    public List<WebElement> componentListH4DataTestID(String dataTestID){
        return Index.getDriver().findElements(By.xpath("//h4[@data-testid='"+dataTestID+"']/a"));
    }
