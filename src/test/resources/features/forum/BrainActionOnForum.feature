...
Feature:  Brian process on Forum
  ...
  Scenario: Brian Add New Forum With Empty Value
    ...
    Then the user sees text "Title is required." displayed success
  ...
  Scenario: Brian Add New Forum
    ...
    And the user seestitle "IsThreadAutotest" is displayed
  ...
  Scenario: Brian verified subscribed threads
    ...
    Then the user seesa element "IsThreadAutotest" is displayed on detail
  ...
  Scenario: Another User Reply Thread
    ...
    And the user sees search field "Search Discussions" and typing keys "IsThreadAutotest"
    And the user access first condition "inputSort"
    And the user access first condition "inputWhen"
    And the user want to click on title "itemTitle" and process
    Then the user seestitle "IsThreadAutotest" is displayed
    And the user adds description
    And the user attaches a photo
    When the user clicks on button "buttonSubmit"
    Then the user sees successful flash message
    Then the user seesdiv element "itemForumPost" displayed
 ...
 Scenario: Brain Search Replies
   ...
   When the user clicks on "More"
   Then the browser opened at item "forum" and tab ""
   And the user sees search field "Search Discussions" and typing keys "TestAutoDescription"
 ...
 Scenario: Brain Reaction On Thread
   ...
   Then the user seeslabel of action "reactionResult" is displayed
  ...
  Scenario: Brain Edit Thread
    ...
    Then the user sees text "Are you sure you want to delete this attachment file?" displayed success
  ...
  Scenario: Brain copy thread with default title
    ...
    Then the user seestitle "Copy - IsThreadAutotest" is displayed
    And the user clicks on button "actionMenuButton"
    And the user clicks on "Delete Thread"
    Then the user sees text "Are you sure you want to delete this thread permanently?" displayed success
    And the user want to "OK"
    Then the user sees successful flash message
